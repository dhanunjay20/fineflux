...
export default function DailyDuties() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`${API_BASE}/api/organizations/${orgId}/employee-duties/employee/${empId}`)
          ...
          {!loading &&
            paginated.map((duty) => {
              const productDisplay =
                duty.productId ||
                (Array.isArray(duty.products) ? duty.products.join(", ") : "—");
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm pt-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium truncate">{productDisplay}</span>
                        </div>
                        <div className="flex items-center gap-2">
